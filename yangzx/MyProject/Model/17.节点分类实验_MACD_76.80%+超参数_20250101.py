...
#参数
# 最优参数 {'ifOpenNormalize': True, 'ifOpenClassWeight': False, 'ifOpenBatchNorm': False, 'residualHistoryN': 8, 'edgeWindowK': 20, 'edgeStride': 1, 'dropoutRate': 0.2, 'ifOpenEdgeDropout': False, 'edgeDropoutRate': 0.2, 'ifOpenFocalLoss': False, 'focalLossGamma': 1.0}
stockCode = '000001.SZ'
dropoutRate = 0.1
...
if ifOpenHyperSearch:
    ...
    for vf1, r, cfg in trial_results[:5]:
        print(f"valF1={vf1:.4f} testF1={r['f1']:.4f} testAcc={r['accuracy']:.4f}  {cfg}")
